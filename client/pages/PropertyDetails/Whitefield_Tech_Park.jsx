...
export default function Details() {
    ...
    const details = {
        ...
        name: "ISDC",
        country: "UK",
        description: "UK-based skill development center",
        start: "01 Aug 2020",
        lockinperiod: 4,
        enddate: "31 Jul 2030",
        totalarea: "1,28,027",
    ...
    return (
        ...
        <div>
            ...
            <Hero2 heading={prprtyname} message='' imageurl={'https://propmedia1.propertyshare.in/website/property/YnlWOFlqaU1EbmRNayswTkR3SWY4dz09/media-v2/images/banner/1440x300/1622016027-whitefield-tech-park-bangalore-1.jpg'} />
            <div className='section1 text-gray-400'>
                ...
                <div>
                                ...
                                <table className="w-full text-sm text-left rtl:text-right overflow-x-auto">
                                    ...
                                    <tbody className=''>
                                        ...
                                        <tr className="">
                                            ...
                                            {
                                                yr.map((year, index) => <td key={index} scope="col" className="px-6 py-4">₹ {"11,00,000"}</td>)
                                            }
                                        </tr>
                                        ...
                                        <tr className="">
                                            ...
                                            {
                                                yr.map((year, index) => <td key={index} scope="col" className="px-6 py-4">{(index == yr.length - 1) ? <> ₹ {"1,20,89,66,395"}</> : undefined}</td>)
                                            }
                                        </tr>
                                        ...
                                        <tr className="">
                                            ...
                                            </td>
                                            {
                                                yr.map((year, index) => <td key={index} scope="col" className="px-6 py-4">₹{
                                                    index === yr.length - 1
                                                        ?
                                                        Number("1,20,89,66,395".replace(/\,/g, '')) + Number(year.replace(/\,/g, '')) + Number("11,00,000".replace(/\,/g, ''))
                                                        :
                                                        Number(year.replace(/\,/g, '')) + Number("11,00,000".replace(/\,/g, ''))
                                                }</td>)
                                            }
                                        </tr>
                                    </tbody>
                    ...
                    <div className="lg:w-3/4 rounded overflow-x-auto shadow-lg shadow-gray-600 card">
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1943.886246748671!2d77.73413353853176!3d12.986398110442225!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae11e5289b4e33%3A0xfe65e927b13be5ec!2sINTERNATIONAL%20TECH%20PARK%2C%20Whitefield%20Main%20Rd%2C%20Pattandur%20Agrahara%2C%20Whitefield%2C%20Bengaluru%2C%20Karnataka%20560066!5e0!3m2!1sen!2sin!4v1705213385105!5m2!1sen!2sin" allowFullScreen={true} width={"100%"} height={"500"} loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
