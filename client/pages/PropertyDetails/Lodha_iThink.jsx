...
export default function Details() {
    ...
    const capitalappreciation = 7.5;

    const yr = ["3,26,58,883", "2,86,98,883", "2,86,98,883", "3,33,71,044", "3,33,71,044"]
    const prprtyname = "Lodha iThink", invamt = "39,60,00,000", mr = "22,10,818", pmf = "3,30,000", tds = "2,45,647"
    ...
    const details = {
        ...
        country: "India",
        description: "Leading automotive finance provider for commercial and personal advice",
        start: "01 Nov 2021",
        lockinperiod: 3,
        enddate: "31 Oct 2026",
        totalarea: "35,802",
    ...
    return (
        ...
        <div>
            ...
            <Hero2 heading={prprtyname} message='' imageurl={'https://propmedia2.propertyshare.in/website/property/Mm1rMWthZHN1V0x3ejlWQlN5TmJCUT09/media-v2/images/banner/1440x300/1631124571-lodha-ithink-mumbai-1.jpg'}/>
            <div className='section1 text-gray-400'>
                        ...
                        <div className="px-6 pt-4 pb-2 gap-2">
                            <div className="grid grid-cols-2 gap-0">
                                <div>
                                    ...
                                    <h1><b className="text-gray-300" >{8.44} %</b> <br /> HIGH RENTAL YEILD </h1>
                                </div>
                                <div>
                                    ...
                                    <h1><b className="text-gray-300" >{15.0} %</b> <br /> HIGH RETURNS </h1>
                                </div>
                                <div className=''>
                                    ...
                                    <h1><b className="text-gray-300" >₹ {"10,000"} psf</b> <br /> ATTRACTIVE PRICE </h1>
                                </div>
                                <div className=''>
                                    ...
                                    <h1><b className="text-gray-300" >{"MUMBAI"}</b> <br />LOCATION</h1>
                                </div>
                ...
                <div>
                                ...
                                <table className="w-full text-sm text-left rtl:text-right overflow-x-auto">
                                    ...
                                    <tbody className=''>
                                        ...
                                        <tr className="">
                                            ...
                                            {
                                                yr.map((year, index) => <td key={index} scope="col" className="px-6 py-4">₹ {"7,78,694"}</td>)
                                            }
                                        </tr>
                                        ...
                                        <tr className="">
                                            ...
                                            {
                                                yr.map((year, index) => <td key={index} scope="col" className="px-6 py-4">{(index == yr.length - 1) ? <> ₹ {"56,85,93,701"}</> : undefined}</td>)
                                            }
                                        </tr>
                                        ...
                                        <tr className="">
                                            ...
                                            </td>
                                            {
                                                yr.map((year, index) => <td key={index} scope="col" className="px-6 py-4">₹{
                                                    index === yr.length - 1
                                                        ?
                                                        Number("56,85,93,701".replace(/\,/g, '')) + Number(year.replace(/\,/g, '')) + Number("7,78,694".replace(/\,/g, ''))
                                                        :
                                                        Number(year.replace(/\,/g, '')) + Number("7,78,694".replace(/\,/g, ''))
                                                }</td>)
                                            }
                                        </tr>
                                    </tbody>
                    ...
                    <div className="lg:w-3/4 rounded overflow-x-auto shadow-lg shadow-gray-600 card">
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3767.6298189971153!2d72.96890617489524!3d19.211364247709653!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b8e76966adcd%3A0xbccb7d295f9e70c8!2sLODHA%20iThink!5e0!3m2!1sen!2sin!4v1705213322305!5m2!1sen!2sin"  allowFullScreen={true} width={"100%"} height={"500"} loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
