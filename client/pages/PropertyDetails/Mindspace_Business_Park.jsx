...
export default function Details() {
    ...
    return (
        ...
        <div>
            ...
            <Hero2 heading={prprtyname} message='' />
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-3 gap-4 w-full my-10">
                                            <div className="col-span-3 text-start mx-6 my-2">
                                                ...
                                                <h1><b>Time Period (P.A): </b><span className=' text-red-400'> {tatacroma.length * 12} Months</span></h1>
                                                <h1>
                                                ...
                                                <h1>
                                                    <Typography variant='h4' className='text-gray-200'>₹ {((value / 100000 + value / 100000 * (capitalappreciation / 100)) * (tatacroma.length)).toFixed(2)} Lakhs</Typography>
