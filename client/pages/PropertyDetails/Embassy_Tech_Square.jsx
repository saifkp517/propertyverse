                    ...
                    <div className="lg:w-3/4  p-4 rounded overflow-hidden shadow-lg shadow-gray-600 card">
                        ...
                        <div className="row sm:grid grid-cols-4 gap-4">
                            ...
                            <div className="flex col-span-2 flex-col">
                                ...
                                <h1><b className="text-gray-300 text-2xl " >{"LG Soft India"}</b></h1>
                            </div>
                            <div className="flex col-span-2 flex-col">
                                <Typography variant='h4' className='my-2 text-xl text-red-400'>Country</Typography>
                                <h1><b className="text-gray-300 text-2xl" >{"South Korea"}</b></h1>
                            </div>
                            <div className="col-span-4 ">
                                <Typography variant='h4' className='my-2 text-xl text-red-400'>Description</Typography>
                                <p className="text-gray-300">{"Leading automotive finance provider for commercial and personal vehicles"}</p>
                            </div>
                            ...
                            <div className="flex lg:col-span-1 sm:col-span-2">
                                ...
                                <div className='mt-4'>
                                    ...
                                    <h4><b className="text-gray-300">{"01 Nov 2021"}</b></h4>
                                </div>
                            </div>
                            <div className="flex lg:col-span-1 sm:col-span-2">
                                <div className="m-4 border rounded-full  border-gray-600  p-5">
                                ...
                                <div className='mt-4'>
                                    ...
                                    <h4><b className="text-gray-300" >3 YEARS</b></h4>
                                </div>
                            </div>
                            <div className="flex lg:col-span-1 sm:col-span-2">
                                ...
                                <div className='mt-4'>
                                    ...
                                    <h4><b className="text-gray-300" >{"31 Oct 2026"}</b></h4>
                                </div>
                            </div>
                            <Typography variant='h4' className="col-span-4 text-xl text-red-400">Tenant Highlights</Typography>
                            <div className="">
                                <h4><b className="text-gray-300" >{"84,512"} SF</b></h4>
                                <h6>TOTAL AREA</h6>

                            </div>
                            <div className="">
                                <h4><b className="text-gray-300" >88</b></h4>
                                <h6>RENT PER SF</h6>

                            </div>
                            <div className="  ">
                                <h4><b className="text-gray-300" >5 YEARS</b></h4>
                                <h6>LEASE PERIOD</h6>
