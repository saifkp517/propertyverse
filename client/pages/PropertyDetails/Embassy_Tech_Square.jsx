...
export default function Details() {
  ...
  const prprtyname = 'Embassy Tech Square',
    invamt = '68,60,00,000',
    mr = '38,62,500',
    pmf = '5,71,667',
    tds = '4,29,167';
  ...
  return (
    <div>
      ...
      <Hero2
        ...
        message=''
        imageurl={
          'https://propmedia1.propertyshare.in/website/property/d3Joby9VTnlncndkZit1ZlAxQ2ZMdz09/media-v2/images/banner/1440x300/1638176086-embassy-tech-square-bangalore-1.jpg'
        }
      />
      <div className='section1 text-gray-400'>
        <div className='flex md:flex-row  flex-wrap'>
          <div
            className='w-full md:3/4 lg:w-2/4 p-4 text-center'
            style={{ minHeight: '5' }}
          >
            ...
            <div className='px-6 pt-4 pb-2 gap-2'>
              <div className='grid grid-cols-2 gap-0'>
                <div>
                  ...
                  <h1>
                    <b className='text-gray-300'>{8.62} %</b> <br /> HIGH RENTAL
                    YEILD{' '}
                  </h1>
                </div>
                <div>
                  ...
                  <h1>
                    <b className='text-gray-300'>{15.9} %</b> <br /> HIGH
                    RETURNS{' '}
                  </h1>
                </div>
                <div className=''>
                  <svg
                    className='w-24 mx-auto h-24 rounded bg-gray-900 p-3'
                    xmlns='http://www.w3.org/2000/svg'
                    width='64'
                    height='64'
                    fill='currentColor'
                  ...
                  <h1>
                    <b className='text-gray-300'>₹ {'13,253'} psf</b> <br />{' '}
                    ATTRACTIVE PRICE{' '}
                  </h1>
                </div>
                <div className=''>
                  ...
                  <h1>
                    <b className='text-gray-300'>{'ORR'}</b> <br />
                    LOCATION
                  </h1>
                </div>
              </div>
        ...
        <div>
          ...
          <h1 className='text-2xl mx-10'>
            Investment Amount:{' '}
            <span className='bg-gray-500 p-2 ml-2 text-gray-900'>
              ₹ 1,23,30,00,000
            </span>
          </h1>
                ...
                <table className='w-full text-sm text-left rtl:text-right overflow-x-auto'>
                  ...
                  <tbody className=''>
                    <tr className=''>
                      ...
                      {yr.map((year, index) => (
                        <td key={index} scope='col' className='px-6 py-4'></td>
                      ))}
                    </tr>
                    <tr className=''>
                      <th
                    ...
                    <tr className=''>
                      <th
                        scope='row'
                        className='px-6 py-4 font-large whitespace-nowrap dark:text-white'
                      >
                        Total:
                      </th>
                      <td className='px-6 py-4'></td>
