...
export default function Home() {
  return (
    <div className=''>
      ...
      <Hero heading='Property Verse' message='Welcome to a redefinition of property management. Discover seamless solutions for property owners and tenants alike' />
      <div className='section1'>
        <h1 className='font-sans text-center text-4xl text-gray-500'>All Properties</h1>
        <br />
