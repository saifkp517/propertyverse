          ...
          <div className="container mx-auto flex flex-wrap items-center justify-between">
            ...
            <div className="md:flex justify-between items-center w-full md:w-auto md:order-1" id="mobile-menu-3">
              ...
              <li style={{ display: "flex" }}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="red" className="bi bi-buildings" viewBox="0 0 16 16">
                  ...
                  <Link href="/properties"><p style={{ cursor: "pointer" }} className='text-gray-600 hover:bg-gray-50 lg:text-xl  md:hover:bg-transparent block pl-3 ml-2 pr-4 py-2 border-b border-red-500 md:hover:text-red-700 md:p-0'>Retail Properties</p></Link>
                </li>
                <li style={{ display: "flex" }}>
