    ...
    return (
        <div>
            ...
            <section className='my-36 ' style={{ minHeight: "100vh" }}>
                ...
                <Typography className='text-xl text-center text-gray-400'>Lorem ipsum dolor sit amet.</Typography>
                <hr className='my-5 lg:mx-24 md:mx-14 sm:mx-2 line' />

                <div className="lg:mx-24 md:mx-14 sm:mx-2 my-10">
                    <Image objectFit='cover' layout='responsive' height={30} width={100} src="https://images.unsplash.com/photo-1471039497385-b6d6ba609f9c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
                </div>
