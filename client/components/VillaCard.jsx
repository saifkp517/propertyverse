                            ...
                            <li className="flex justify-between gap-x-6 py-5">
                                <div className="flex min-w-0 gap-x-4">
                                    <div className="min-w-0 text-left flex-auto">
                                        ...
                                        <Typography className="text-sm font-semibold leading-6 text-gray-400">BUA </Typography>
                                    </div>
                                </div>
                                <div className="shrink-0 sm:flex sm:flex-col sm:items-end ">
                                    <Typography className="text-sm font-bold leading-6 text-gray-300">{area} SF</Typography>
                                    <Typography className="text-sm font-bold leading-6 text-gray-300">{bua} SF</Typography>
                                </div>
                            </li>
                        </ul>
                        {
