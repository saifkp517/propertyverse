    ...
    <div className="flex-wrap">
      ...
      <div className="max-w-sm rounded overflow-hidden shadow-lg card">
        <div className="px-6 py-4">
          <div className="font-bold text-xl mb-2">Prestige Tech Platina</div>
          <Image src="https://images.unsplash.com/photo-1481253127861-534498168948?auto=format&fit=crop&q=80&w=1973&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="image" width={100} height={60} layout='responsive' />
          <ul role="list" className="divide-y divide-gray-100">

            <li className="flex justify-between gap-x-6 py-5">
              <div className="flex min-w-0 gap-x-4">
                <div className="min-w-0 flex-auto">
                  <p className="text-sm font-semibold leading-6 text-gray-900">Area</p>
                  <p className="text-sm font-semibold leading-6 text-gray-900">Price psf</p>
                  <p className="text-sm font-semibold leading-6 text-gray-900">Yield</p>
                  <p className="text-sm font-semibold leading-6 text-gray-900">Return Targe</p>
                  <p className="mt-1 truncate text-xs leading-5 text-gray-500">courtney.henry@example.com</p>
                </div>
              </div>
              <div className="shrink-0 sm:flex sm:flex-col sm:items-end">
                <p className="text-sm leading-6 text-gray-900">1,71,231 SF</p>
                <p className="text-sm leading-6 text-gray-900">1,71,231 SF</p>
                <p className="text-sm leading-6 text-gray-900">1,71,231 SF</p>
                <p className="text-sm leading-6 text-gray-900">1,71,231 SF</p>
