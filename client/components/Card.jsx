        ...
        <div className="sm:max-w-36 rounded overflow-hidden shadow-lg shadow-gray-600 card">
          <div className="px-6 py-4">
            ...
            <Link href={`${redirectUrl}`} >
              <button type="button" className="text-gray-900 bg-gradient-to-r from-red-500 via-red-700 to-red-900  hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-100 dark:focus:ring-red-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-0">View Opportunity</button>
            </Link>
