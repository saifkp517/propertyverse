      ...
      <div className="flex-wrap">
        <div className="sm:max-w-36 rounded-2xl overflow-hidden shadow-lg shadow-gray-700 card">
          <div className="p-6">
            ...
            <div className="m-2 text-gray-400">{name} <br /> <sub>{location}</sub> </div>
            <hr />
            <ul role="list" className="divide-y divide-gray-900">
              ...
              <li className="flex justify-between gap-x-6 py-5">
                ...
                <div className="shrink-0 sm:flex sm:flex-col sm:items-end ">
                  <Typography className="text-sm leading-6 font-bold text-gray-300">{area} SF</Typography>
                  <Typography className="text-sm leading-6 font-bold text-gray-300"> ₹{pricesqf}</Typography>
                  <Typography className="text-sm leading-6 font-bold text-gray-300">{yeild} %</Typography>
                  <Typography className="text-sm leading-6 font-bold text-gray-300">{returntarget} %</Typography>

                </div>
              </li>
            </ul>
            <button type="button" className=" hover:transition ease-in-out w-full text-white tracking-widest font-extrabold bg-gradient-to-r from-red-500 via-red-500 to-red-600 shadow-lg shadow-gray-600/40 hover:bg-gradient-to-br active:border focus:ring-4 focus:outline-none focus:ring-transparent dark:focus:ring-red-400 rounded-xl text-sm p-4 text-center mr-2 mb-0">View Opportunity</button>              
