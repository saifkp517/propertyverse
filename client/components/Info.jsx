        ...
        <div>
            <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-32 gap-y-4 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8 ">
                ...
                <div className="gap-4 sm:gap-72 lg:gap-8">
                    <Image src="https://plus.unsplash.com/premium_photo-1678963247830-fc7a3ac060d5?q=80&w=1904&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" layout="responsive" height={10} width={10} className="rounded-lg bg-gray-100" />
                </div>
            </div>
        </div>
