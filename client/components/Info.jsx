    ...
    <div>
      <div className='mx-auto grid max-w-xl grid-cols-1 items-center gap-x-10 gap-y-4 px-4 py-16 sm:px-6 sm:py-32 lg:max-w-full lg:grid-cols-2 lg:px-8 '>
        <div className='top-0 left-0 gap-4 sm:gap-72 lg:gap-8 mb-14 '>
          <div className='shadow-xl flex flex-row w-full max-w-[48rem] rounded-xl bg-gray-200 bg-clip-border text-gray-700 shadow-gray-500 box-shadow-lg'>
            ...
            <div className='p-6'>
              <h6 className='mb-4 flex items-center gap-2 font-sans text-base font-semibold uppercase leading-relaxed tracking-normal text-red-500 antialiased'>
                <svg
              ...
              <h4 className='mb-4 block font-sans text-2xl font-semibold leading-snug tracking-normal text-blue-gray-900 antialiased'>
                {properties[count].name}
              </h4>
              <p className='mt-2 block font-sans text-base font-semibold leading-relaxed text-red-500 antialiased'>
                Yeild -{' '}
                <span className='text-gray-500'>
                  {properties[count].yeild}%
                </span>
              </p>
              <p className='mb-4 block font-sans text-base font-semibold leading-relaxed text-red-500 antialiased'>
                Return Target -{' '}
                <span className='text-gray-500'>
                  {properties[count].returntarget}%
                </span>
              </p>
              <Link
                className='inline-block'
                href={`/PropertyDetails/${properties[count].name
                  .split(' ')
                  .join('_')}`}
              >
                <button
                  className='flex select-none items-center gap-2 rounded-lg py-3 text-center align-middle font-sans text-xs font-bold uppercase text-red-500 transition-all disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none px-0 pr-5'
                  type='button'
                >
                  Interested?
                  <svg
        ...
        <div>
          ...
          <p className='mt-4 text-gray-500'>
            Explore a diverse range of fractional ownership opportunities in
            premium real estate.
          </p>
          ...
          <dl className='mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-x-8'>
            ...
            <div className='border-t border-gray-200 pt-4'>
              ...
              <dd className='mt-2 text-sm text-gray-400'>
                Experience the benefits of real estate investment without the
                burden of full ownership.
              </dd>
            </div>
            <div className='border-t border-gray-200 pt-4'>
              <dt className='font-medium text-red-600'>
                Expertly Vetted Properties
              </dt>
              <dd className='mt-2 text-sm text-gray-400'>
                Invest with confidence in meticulously vetted and high-potential
                properties.
              </dd>
            </div>
            <div className='border-t border-gray-200 pt-4'>
              ...
              <dd className='mt-2 text-sm text-gray-400'>
                Navigate seamlessly through our intuitive platform designed for
                your convenience.
              </dd>
            </div>
            <div className='border-t border-gray-200 pt-4'>
              ...
              <dd className='mt-2 text-sm text-gray-400'>
                Enjoy responsive customer support for a hassle-free investing
                experience.
              </dd>
            </div>
