...
const Footer = () => {
    return (
        <footer className="p-4 bg-gradient-to-r from-red-500 via-red-700 to-red-900 sm:p-6">
        <div className="mx-auto max-w-screen-xl">
            <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0">
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">PropertyVerse</span>
                </div>
